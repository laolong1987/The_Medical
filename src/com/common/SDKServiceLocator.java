...
public class SDKServiceLocator extends org.apache.axis.client.Service implements com.common.SDKService {
...
//    private java.lang.String SDKService_address = "http://116.58.219.223:8081/sdk/SDKService";
    	 ...
    	 private java.lang.String SDKService_address =SettingUtil.getSetting("uri");
    ...
    public com.common.SDKClient getSDKService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.common.SDKServiceBindingStub _stub = new com.common.SDKServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.common.SDKClient.class.isAssignableFrom(serviceEndpointInterface)) {
                com.common.SDKServiceBindingStub _stub = new com.common.SDKServiceBindingStub(new java.net.URL(SDKService_address), this);
                _stub.setPortName(getSDKServiceWSDDServiceName());
                return _stub;
            }
        }
